...
//     final baseUrlCases = flavors.map((f) {
//       final enumName = _toEnumName(f.name);
//       return '''
...
//     final defaultEnum = flavors.isNotEmpty ? _toEnumName(flavors.first.name) : 'dev';
...
//     print('✏️  Wrote lib/core/config/server_config.dart');
//   }
